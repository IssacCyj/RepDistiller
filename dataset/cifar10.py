...
class CIFAR10Instance(ImbalanceCIFAR10):
...
def get_cifar10_dataloaders(batch_size=128, num_workers=8, is_instance=False, train_rule=None):
    """
    cifar 10
    """
    ...
    if is_instance:
        ...
        train_set = ImbalanceCIFAR10(root=data_folder,
                                      download=True,
                                      train=True,
                                      transform=train_transform)
...
class CIFAR10InstanceSample(ImbalanceCIFAR10):
    """
