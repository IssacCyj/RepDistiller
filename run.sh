...
python train_student.py --path_t save/models/resnet110_cifar10_lr_0.05_decay_0.0005_trial_0/resnet110_best.pth --distill kd --model_s resnet110 -r 0.1 -a 0.9 -b 0.0 --train_rule Resample --mask_head 9 --trial maskhead9
